...
submissions_dataset = '../dataset/01_submissions.csv'
filtered_submissions_dataset = '../dataset/04_filtered_submissions.csv'

# load dataset
data = pd.read_csv(filtered_submissions_dataset)
