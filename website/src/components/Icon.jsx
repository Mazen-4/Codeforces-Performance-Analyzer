...
const PATHS = {
  ...
  shield:   ["M12 2 4 5.5V11c0 5 3.4 9.3 8 10.5 4.6-1.2 8-5.5 8-10.5V5.5L12 2Z",
             "M9 12l2 2 4-4"],
  diamond:  ["M12 2.5 3 10l9 11.5L21 10 12 2.5Z",
             "M3 10h18", "M8.5 10 12 2.5 15.5 10", "M8.5 10 12 21.5 15.5 10"],
  ...
  chat:     ["M21 15a3 3 0 0 1-3 3H8l-5 4V6a3 3 0 0 1 3-3h12a3 3 0 0 1 3 3v9Z",
             "M8 9h8M8 13h5"],
  github:   ["M9 19c-4.5 1.5-4.5-2.5-6-3m12 6v-3.5c0-1 .1-1.4-.5-2 2.8-.3 5.5-1.4 5.5-6a4.6 4.6 0 0 0-1.3-3.2 4.3 4.3 0 0 0-.1-3.2s-1.1-.3-3.5 1.3a12 12 0 0 0-6.2 0C6.5 2.8 5.4 3.1 5.4 3.1a4.3 4.3 0 0 0-.1 3.2A4.6 4.6 0 0 0 4 9.5c0 4.6 2.7 5.7 5.5 6-.6.6-.6 1.2-.5 2V21"],
};
